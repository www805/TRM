...
public class AddRecord_Thread extends Thread {
    ...
    @Override
    public void run() {
        LogUtil.intoLog("AddRecord_Thread__笔录结束时生成Pdf开始__recordssid__"+recordssid+"__mtssid__"+mtssid);
        ...
        LogUtil.intoLog("AddRecord_Thread__笔录结束时生成Pdf结束__recordssid__"+recordssid+"__mtssid__"+mtssid);
    }
}
