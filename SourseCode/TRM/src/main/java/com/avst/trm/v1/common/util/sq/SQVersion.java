...
public class SQVersion {

    public static String S_V = "s_v";//单机版
    public static String O_V = "o_v";//联机版

    public static String C_E = "c_e";//客户端
    public static String S_E = "s_e";//服务器
