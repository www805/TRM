...
public class CInterceptorConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registration.excludePathPatterns("/login", "/error", "/static/**", "/static/layui/iconz", "/logout", "/cweb/base/main/getNavList","/cweb/base/main/getPant","/cweb/base/main/updatePassWord","/cweb/base/main/gotoforgotpassword","/cweb/base/main/uploadkey","/cweb/base/main/getLoginCookie");       //添加不拦截路径
