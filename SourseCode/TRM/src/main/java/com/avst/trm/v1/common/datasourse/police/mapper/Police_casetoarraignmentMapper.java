...
public interface Police_casetoarraignmentMapper extends BaseMapper<Police_casetoarraignment> {
    ...
    @Select("select a.*,r.recordname,r.recordbool,r.recordtypessid,au1.username as adminname ,au2.username as recordadminname,r.ssid as recordssid,rt.typename as recordtypename" +
